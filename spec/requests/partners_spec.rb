...
RSpec.describe "/partners", type: :request do
  ...
  # PartnersController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get partners_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Partner" do
        expect {
          post partners_url,
               params: { partner: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Partner" do
        expect {
          post partners_url,
               params: { partner: invalid_attributes }, as: :json
        }.to change(Partner, :count).by(0)
      end

      it "renders a JSON response with errors for the new partner" do
        post partners_url,
             params: { partner: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested partner" do
        partner = Partner.create! valid_attributes
        patch partner_url(partner),
              params: { partner: invalid_attributes }, headers: valid_headers, as: :json
        partner.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the partner" do
        partner = Partner.create! valid_attributes
        patch partner_url(partner),
              params: { partner: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the partner" do
        partner = Partner.create! valid_attributes
        patch partner_url(partner),
              params: { partner: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested partner" do
      partner = Partner.create! valid_attributes
      expect {
        delete partner_url(partner), headers: valid_headers, as: :json
      }.to change(Partner, :count).by(-1)
    end
  end
end
