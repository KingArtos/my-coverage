...
[
   ...
   },
   {
	...
	puts "creating partner id: #{partner[:id]}"
  begin
    hash = partner.deep_transform_keys { |k| k.to_s.underscore.to_sym }
  	result = Partner.new(PartnerConverter.to_object(hash))
    puts "saved: #{result.save}"
  rescue => e
